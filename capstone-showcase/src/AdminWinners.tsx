      ...
      <div className="projects-list">
        {projects.length === 0 ? (
          ...
          <div className="edit-submission-table">
            <div>
                {
                    selectedWinners && selectedWinners.length > 0 && selectedWinners.map((winner) => (
                        <span key={winner.position}>
                            {winner.position == "1" && <img src="/1stplace.svg" alt="1st Place" className="admin-podium-highlight" />}
                            {winner.position == "2" && <img src="/2ndplace.svg" alt="2nd Place" className="admin-podium-highlight" />}
                            {winner.position == "3" && <img src="/3rdplace.svg" alt="3rd Place" className="admin-podium-highlight" />}
