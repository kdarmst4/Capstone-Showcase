...
export const iraEngineeringText: string = "Ira A. Fulton Schools of Engineering"
export const projectTitle: string = "Senior Capstone Project Showcase"

export const landingPageIntro: string = `For the last two semesters students majoring in Computer Science, 
