...
const IndustrialEngineering: React.FC = () => {
  ...
  useEffect(() => {
    ...
    fetch(
      `${API_BASE_URL}/survey/industrial-engineering/term=${semester}-${year}`
        ...
        <section className="event-details">
          <article>
            ...
            <div className="title-container">
              <h3 className="main-page-title">Industrial Engineering</h3>
              <button
            ...
            <div className="project-showcase-header">
              ...
              <div className="project-showcase-info">
                ...
                <div className="project-showcase-meta">
                  <span className="project-showcase-category">Industrial Engineering</span>
