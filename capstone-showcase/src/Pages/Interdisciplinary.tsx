...
const Interdisciplinary: React.FC = () => {
  ...
  useEffect(() => {
    ...
    fetch(`${API_BASE_URL}/survey/interdisciplinary/term=${semester}-${year}`) // Fetch projects for the Computer Science major
      .then((response) => {
        if (!response.ok) {
        ...
        <section className="event-details">
          <article>
            ...
            <div className="title-container">
              <h3 className="main-page-title">Interdisciplinary</h3>
              <button
