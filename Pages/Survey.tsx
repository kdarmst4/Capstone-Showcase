  ...
  const handleChange = (
    ...
    if (name === "major") {
      setFormData((prevFormData) => {
        const updatedMajors = checked
          ? [...prevFormData.major, value]
          : prevFormData.major.filter((major) => major !== value);
        return { ...prevFormData, major: updatedMajors };
      });
    } else {
  ...
  const validateFormData = (formData: FormData) => {
    ...
    const errors: FormErrors = {
      ...
      teamMemberNames: !teamMemberNames
        ...
        : "",
      major: !major ? "Please select a course." : "",
      demo: !demo
  ...
  return (
    <div className="form-container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
        <label htmlFor="teamMemberNames">Capstone Poster</label>
      <form onSubmit={handleSubmit}>
          ...
          <div className="checkbox-group-wrapper">
            <div className="checkbox-labels">
              {[
                ...
                <div key={major}>
                  <label htmlFor={major.toLowerCase().replace(/\s+/g, '-')}>{major}</label>
                </div>
              ))}
            </div>
            <div className="checkbox-group">
              {[
                ...
                <div key={major}>
                  <input
                    type="checkbox"
                    id={major.toLowerCase().replace(/\s+/g, '-') }
                    name="major"
                    value={major.toLowerCase().replace(/\s+/g, '-') }
                    checked={formData.major.includes(major.toLowerCase().replace(/\s+/g, '-'))}
                    onChange={handleChange}
                  />
                </div>
              ))}
